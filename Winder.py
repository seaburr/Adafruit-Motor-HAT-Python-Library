    ...
    def rotate_watch(self):
        ...
        while(i < self.turns_between_pause):
            if (self.turn_type == "CW"):
                self.my_stepper.step(self.steps_per_rev, Adafruit_MotorHAT.FORWARD, Adafruit_MotorHAT.MICROSTEP)
            elif (self.turn_type == "CCW"):
                self.my_stepper.step(self.steps_per_rev, Adafruit_MotorHAT.BACKWARD, Adafruit_MotorHAT.MICROSTEP)
